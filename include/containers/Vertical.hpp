    ...
    class VLayout : public Container {
        ...
        void layoutPass() override {
            ...
            for(auto& child : children){
                ...
                child->e_position = sf::Vector2f(e_position.x, e_position.y + y) + e_padding;
        ...
        void sizePass() override {
            ...
            if(e_sizeType == sizeTypes::fitContent){
                ...
                e_size.x = maxWidth + e_padding.x * 2;
                e_size.y = height + e_padding.y * 2 - spacing; // -spacing to remove the last extra spacing added at the last ranged loop iteration
            }
        }
